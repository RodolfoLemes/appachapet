      ...
      <ScrollView style={{ flex: 1, width: '100%' }}>
        ...
        >
          <View style={dataStyles.topInfo}>
            <View style={dataStyles.topInfoTexts}>
              ...
              <View style={dataStyles.topInfoTextsSubtitle}>
                <Text style={dataStyles.topInfoTextsSubtitleFont}>
                  Estou em casa
                </Text>
              </View>
            </View>
          ...
          <TextInput
            ref={textRef}
            style={
              onFocusPetName ? dataStyles.infoViewFocused : dataStyles.infoView
            }
          ...
          <TextInput
            style={
              onFocusCep ? dataStyles.infoViewFocused : dataStyles.infoView
            }
            ...
            editable={editable}
          />
          <TouchableOpacity style={dataStyles.bottomButton} onPress={sendData}>
            <Text style={dataStyles.bottomButtonFont}>
              {editable ? 'Enviar' : 'Editar'}
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
