              ...
              if (index == 0) {
                ...
                return (
                  <Marker
                    key={element._id}
                    title={`${
                      element.isWifi ? 'Wi-fi' : 'GPRS'
                    } - Estive aqui as ${data.getHours()}:${data.getMinutes()} - Dia: ${data.getDate()}/${data.getMonth()}`}
        ...
        <View style={gpsStyles.topInfoTexts}>
          ...
          <View style={gpsStyles.topInfoTextsSubtitle}>
            <Text style={gpsStyles.topInfoTextsSubtitleFont}>
              {markers
                ? markers[0]?.isWifi
                  ? 'Seu pet está dentro do seu Wi-fi'
                  : markers[0]?.isGeofencing
                  ? 'Seu pet está por perto!'
                  : 'SEU PET SAIU SOCORORRORO'
                : 'Humano bobo'}
            </Text>
          </View>
        </View>
        <View style={gpsStyles.topInfoImg}>
          ...
          <View style={gpsStyles.brtyView}>
            <React.Fragment>
              {device.battery == 'Ruim' ? (
                <Image
                  source={require('../../assets/lowBtry.png')}
                  style={gpsStyles.btryImg}
                />
              ) : device.battery == 'Carregada' ? (
                <Image
                  source={require('../../assets/mediumBtry.png')}
                  style={gpsStyles.btryImg}
                />
              ) : (
                <Image
                  source={require('../../assets/goodBtry.png')}
                  style={gpsStyles.btryImg}
                />
              )}
            </React.Fragment>
